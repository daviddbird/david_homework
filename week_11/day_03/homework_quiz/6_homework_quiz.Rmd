...
**A. A lower RMSE is best - however the error will always be greater on the test data as the model will not have seen that data before. So not sure why the error should be lower on the test set? **
