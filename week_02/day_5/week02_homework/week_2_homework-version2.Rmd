...
username <- key_get("postgresql_username", keyring = "local2")
password <- key_get("postgresql_password", keyring = "local2")
...
readr::write_csv(employees_with_teams_feedbacks_api, "./data/processed/employees_with_teams_feedbacks.csv")
jsonlite::write_json(employees_with_teams_feedbacks_api, "./data/processed/employees_with_teams_feedbacks.json")
```
